<?php
/*
Current Theme Addon: Theme Updater for OIT Flex on GitHub
...
function transient_update_themes_filter($data){
	...
	$theme = $theme_data;
	$github_username = 'ncsuwebdev';
	$github_repo = 'WordPress-theme--OITFlex';
	$github_theme_uri = 'https://github.com/ncsuwebdev/WordPress-theme--OITFlex.git';
